...
namespace EnhancedScrollerDemos.PullDownRefresh
{
    ...
    public class Controller : MonoBehaviour, IEnhancedScrollerDelegate, IBeginDragHandler, IEndDragHandler
    {
       ...
       // private SmallList<Data> _data;
        ...
        SmallList<Video> _data = new SmallList<Video>();
        ...
        {
            _data = LocalVideoManager.instance.GetAllLocalVideosSmall();
        ...
        public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
        {
            ...
            LocalVideoUI cellView = scroller.GetCellView(cellViewPrefab) as LocalVideoUI;
            ...
            cellView.Setup(_data[dataIndex]);
