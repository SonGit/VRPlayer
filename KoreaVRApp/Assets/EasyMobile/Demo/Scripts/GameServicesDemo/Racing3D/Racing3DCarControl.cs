...
namespace EasyMobile.Demo
{
    public class Racing3DCarControl : MonoBehaviour
    {
        ...
        public void StartMoving(bool controllable)
        {
            ...
            //autoFillNitroCoroutine = StartCoroutine(AutoFillNitroCoroutine());
        }
        ...
        public void Move(Racing3DGameModel.MoveDirections direction)
        {
            ...
            {
                if (Mathf.Abs(this.transform.position.y - gameControl.OpponentCar.transform.position.y) <= 0.9f)
                    return;
            }
        ...
        private IEnumerator AutoFillNitroCoroutine()
        {
            while (true)
            {
                if (IsMoving)
                ...
                yield return new WaitForSeconds(nitroAutoFillRate);
            }
        }
