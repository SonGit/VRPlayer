...
namespace EasyMobile.Demo
{
    public class Racing3DGameControl : GameServicesDemo_Multiplayer_BaseControl, IRealTimeMultiplayerListener
    {
        ...
        [Header("Side Objects")]
        //[SerializeField]
        //private float sideObjectsZ = -0.5f;
        ...
        [SerializeField]
        private bool hitPowerUp = true, useNitro = false, finish = true, start = true, ready = false;
        ...
        public void OnPeersConnected(string[] participantIds)
        {
            ...
            if (IsPlaying)
            {
                ...
                {
                    GetCarWithId(id).ContinueMoving();
                }
            }
