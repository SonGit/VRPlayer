...
namespace Com.TheFallenGames.OSA.DataHelpers
{
	...
	public class SimpleDataHelper<T> : IEnumerable<T>
	{
		...
		/// <summary>
		/// NOTE: Use <see cref="InsertItems(int, IList{T}, bool)"/> for bulk inserts, as it's way faster
		/// </summary>
		...
		/// <summary>
		/// NOTE: Use <see cref="RemoveItems(int, int, bool)"/> for bulk removes, as it's way faster
		/// </summary>
		/// <param name="index"></param>
		/// <param name="freezeEndEdge"></param>
