	...
	public class BaseItemViewsHolder : AbstractViewsHolder
    {
		...
		public virtual void ShiftIndexInView(int shift, int modulo)
		{
			...
			if (itemIndexInView >= modulo)
				throw new UnityEngine.UnityException("BaseItemViewsHolder.ShiftIndex: (itemIndexInView=" + old + ")+(shift=" + shift + ") >= (modulo=" + modulo + ")");
			if (itemIndexInView < 0)
				throw new UnityEngine.UnityException("BaseItemViewsHolder.ShiftIndex: (itemIndexInView=" + old + ")+(shift=" + shift + ") < 0");
