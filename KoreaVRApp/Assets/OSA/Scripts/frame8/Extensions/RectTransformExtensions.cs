...
//		{ return rt.position.x + (1f - rt.pivot.x) * rt.rect.width; }
		...
		public static void SetInsetAndSizeFromParentLeftEdgeWithCurrentAnchors(RectTransform child, float newInset, float newSize)
		{ child.SetInsetAndSizeFromParentEdgeWithCurrentAnchors(RectTransform.Edge.Left, newInset, newSize); }
		public static void SetInsetAndSizeFromParentRightEdgeWithCurrentAnchors(RectTransform child, float newInset, float newSize)
		{ child.SetInsetAndSizeFromParentEdgeWithCurrentAnchors(RectTransform.Edge.Right, newInset, newSize); }
		public static void SetInsetAndSizeFromParentTopEdgeWithCurrentAnchors(RectTransform child, float newInset, float newSize)
