...
namespace Com.TheFallenGames.OSA.Demos.Hierarchy
{
	...
	public class HierarchySceneEntry : SceneEntry<HierarchyExample, MyParams, FileSystemEntryViewsHolder>
	{
		...
		{
			_Drawer.Init(_Adapters, true, false, false, false, false);
		...
		protected override void OnItemCountChangeRequested(HierarchyExample adapter, int count)
		{
			base.OnItemCountChangeRequested(adapter, count);

			adapter.TryChangeCount(count);
		}
		#endregion
	}
}
